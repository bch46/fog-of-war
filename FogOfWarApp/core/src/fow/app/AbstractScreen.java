...
public abstract class AbstractScreen implements Screen {
	...
	@Override
	public void hide() {
		Gdx.app.log(Main.LOG, "Hiding screen: " + getName());
	...
	@Override
	public void pause() {
		Gdx.app.log(Main.LOG, "Pausing screen: " + getName());
	}

	@Override
	public void resume() {
		Gdx.app.log(Main.LOG, "Resuming screen: " + getName());
	}

	@Override
	public void dispose() {
		Gdx.app.log(Main.LOG, "Disposing screen: " + getName());
